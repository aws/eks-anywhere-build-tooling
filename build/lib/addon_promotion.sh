...
helm pull oci://${ACCOUNT_ID}.dkr.ecr.us-west-2.amazonaws.com/${PRIV_ECR_REPO} --version ${HELM_TAG}-helm
...
helm push ${PRIV_ECR_REPO}-${HELM_TAG}-helm.tgz oci://${IMAGE_REGISTRY}