...
HELM_CHART_FOLDER?=$(shell basename $(HELM_DESTINATION_REPOSITORY))
...
$(call FULL_CHART_TARGETS,replace) : %/helm/replace: %/helm/require | $$(ENABLE_LOGGING)
	@$(BUILD_LIB)/helm_replace.sh $(HELM_CHART_FOLDER) $(OUTPUT_DIR)

$(call FULL_CHART_TARGETS,build) : %/helm/build: %/helm/replace | $$(ENABLE_LOGGING)
	@$(BUILD_LIB)/helm_build.sh $(OUTPUT_DIR) $(HELM_CHART_FOLDER) $(BUILD_HELM_DEPENDENCIES)
