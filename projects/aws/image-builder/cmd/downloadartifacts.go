...
func init() {
	...
	downloadArtifactsCmd.Flags().StringVar(&bo.ReleaseChannel, "release-channel", "1-31", "EKS-D Release channel for node image. Can be 1-27, 1-28, 1-29, 1-30 or 1-31")
	...
	if err := downloadArtifactsCmd.MarkFlagRequired("release-channel"); err != nil {
		log.Fatalf("Please set EKS-D release-channel using --release-channel. Can be 1-27, 1-28, 1-29, 1-30 or 1-31")
	}
}
