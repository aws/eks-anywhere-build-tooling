...
run-in-docker/image-builder/../eks-anywhere-go-mod-download: ## Run `image-builder/../eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/image-builder/linux-amd64/image-builder: ## Run `_output/bin/image-builder/linux-amd64/image-builder` in docker builder container
run-in-docker/_output/bin/image-builder/linux-arm64/image-builder: ## Run `_output/bin/image-builder/linux-arm64/image-builder` in docker builder container
