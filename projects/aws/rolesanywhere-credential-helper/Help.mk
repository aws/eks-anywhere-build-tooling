...
##@ GIT/Repo Targets
clone-repo:  ## Clone upstream `rolesanywhere-credential-helper`
checkout-repo: ## Checkout upstream tag based on value in GIT_TAG file

##@ Binary Targets
binaries: ## Build all binaries: `aws_signing_helper` for `linux/amd64 linux/arm64`
_output/bin/rolesanywhere-credential-helper/linux-amd64/aws_signing_helper: ## Build `_output/bin/rolesanywhere-credential-helper/linux-amd64/aws_signing_helper`
_output/bin/rolesanywhere-credential-helper/linux-arm64/aws_signing_helper: ## Build `_output/bin/rolesanywhere-credential-helper/linux-arm64/aws_signing_helper`
...
run-in-docker/rolesanywhere-credential-helper/eks-anywhere-go-mod-download: ## Run `rolesanywhere-credential-helper/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/rolesanywhere-credential-helper/linux-amd64/aws_signing_helper: ## Run `_output/bin/rolesanywhere-credential-helper/linux-amd64/aws_signing_helper` in docker builder container
run-in-docker/_output/bin/rolesanywhere-credential-helper/linux-arm64/aws_signing_helper: ## Run `_output/bin/rolesanywhere-credential-helper/linux-arm64/aws_signing_helper` in docker builder container
