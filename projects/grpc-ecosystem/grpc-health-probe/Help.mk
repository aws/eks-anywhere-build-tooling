...
##@ GIT/Repo Targets
clone-repo:  ## Clone upstream `grpc-health-probe`
checkout-repo: ## Checkout upstream tag based on value in GIT_TAG file

##@ Binary Targets
binaries: ## Build all binaries: `grpc_health_probe` for `linux/amd64 linux/arm64`
_output/bin/grpc-health-probe/linux-amd64/grpc_health_probe: ## Build `_output/bin/grpc-health-probe/linux-amd64/grpc_health_probe`
_output/bin/grpc-health-probe/linux-arm64/grpc_health_probe: ## Build `_output/bin/grpc-health-probe/linux-arm64/grpc_health_probe`
