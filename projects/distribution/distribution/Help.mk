...
run-in-docker/distribution/eks-anywhere-go-mod-download: ## Run `distribution/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/distribution/linux-amd64/registry: ## Run `_output/bin/distribution/linux-amd64/registry` in docker builder container
run-in-docker/_output/bin/distribution/linux-arm64/registry: ## Run `_output/bin/distribution/linux-arm64/registry` in docker builder container
