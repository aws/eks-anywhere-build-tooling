...
run-in-docker/prometheus/eks-anywhere-go-mod-download: ## Run `prometheus/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/prometheus/linux-amd64/prometheus: ## Run `_output/bin/prometheus/linux-amd64/prometheus` in docker builder container
run-in-docker/_output/bin/prometheus/linux-amd64/promtool: ## Run `_output/bin/prometheus/linux-amd64/promtool` in docker builder container
run-in-docker/_output/bin/prometheus/linux-arm64/prometheus: ## Run `_output/bin/prometheus/linux-arm64/prometheus` in docker builder container
run-in-docker/_output/bin/prometheus/linux-arm64/promtool: ## Run `_output/bin/prometheus/linux-arm64/promtool` in docker builder container
