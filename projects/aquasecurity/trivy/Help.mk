...
run-in-docker/trivy/eks-anywhere-go-mod-download: ## Run `trivy/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/trivy/linux-amd64/trivy: ## Run `_output/bin/trivy/linux-amd64/trivy` in docker builder container
run-in-docker/_output/bin/trivy/linux-arm64/trivy: ## Run `_output/bin/trivy/linux-arm64/trivy` in docker builder container
