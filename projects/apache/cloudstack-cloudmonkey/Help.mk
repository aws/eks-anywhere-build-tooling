...
run-in-docker/cloudstack-cloudmonkey/eks-anywhere-go-mod-download: ## Run `cloudstack-cloudmonkey/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/cloudstack-cloudmonkey/linux-amd64/cmk: ## Run `_output/bin/cloudstack-cloudmonkey/linux-amd64/cmk` in docker builder container
run-in-docker/_output/bin/cloudstack-cloudmonkey/linux-arm64/cmk: ## Run `_output/bin/cloudstack-cloudmonkey/linux-arm64/cmk` in docker builder container
