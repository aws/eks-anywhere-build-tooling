...
##@ GIT/Repo Targets
clone-repo:  ## Clone upstream `chartmuseum`
checkout-repo: ## Checkout upstream tag based on value in GIT_TAG file

##@ Binary Targets
binaries: ## Build all binaries: `chartm` for `linux/amd64 linux/arm64`
_output/bin/chartmuseum/linux-amd64/chartm: ## Build `_output/bin/chartmuseum/linux-amd64/chartm`
_output/bin/chartmuseum/linux-arm64/chartm: ## Build `_output/bin/chartmuseum/linux-arm64/chartm`
