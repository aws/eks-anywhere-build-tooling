...
CRICTL_AMD64_SHA256SUM=$(curl -s $CRICTL_AMD64_URL.sha256 | cut -d ' ' -f1)
CRICTL_ARM64_SHA256SUM=$(curl -s $CRICTL_ARM64_URL.sha256 | cut -d ' ' -f1)
...
CRICTL_AMD64_SHA256SUM=$CRICTL_AMD64_SHA256SUM
CRICTL_ARM64_SHA256SUM=$CRICTL_ARM64_SHA256SUM
