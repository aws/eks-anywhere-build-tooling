...
# https://github.com/kubernetes-sigs/kind/blob/v0.33.0/pkg/build/nodeimage/const_cni.go#L23
KINDNETD_IMAGE_TAG="docker.io/kindest/kindnetd:v20260820-69b56db7"
# https://github.com/kubernetes-sigs/kind/blob/v0.33.0/pkg/build/nodeimage/const_storage.go#L29
LOCAL_PATH_PROVISONER_IMAGE_TAG="docker.io/kindest/local-path-provisioner:v20260820-69b56db7"
# https://github.com/kubernetes-sigs/kind/blob/v0.33.0/pkg/build/nodeimage/const_storage.go#L29
LOCAL_PATH_HELPER_IMAGE_TAG="docker.io/kindest/local-path-helper:v20260131-7181c60a"
# https://github.com/kubernetes-sigs/kind/blob/v0.33.0/images/base/files/etc/containerd/config.toml#L37
