...
# https://github.com/kubernetes-sigs/kind/blob/v0.27.0/pkg/build/nodeimage/const_cni.go#L23
KINDNETD_IMAGE_TAG="docker.io/kindest/kindnetd:v20250214-acbabc1a"
# https://github.com/kubernetes-sigs/kind/blob/v0.27.0/pkg/build/nodeimage/const_storage.go#L29
...
# https://github.com/kubernetes-sigs/kind/blob/v0.27.0/images/base/files/etc/containerd/config.toml#L37
