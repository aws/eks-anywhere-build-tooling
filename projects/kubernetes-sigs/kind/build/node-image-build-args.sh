...
# https://github.com/kubernetes-sigs/kind/blob/v0.28.0/pkg/build/nodeimage/const_cni.go#L23
KINDNETD_IMAGE_TAG="docker.io/kindest/kindnetd:v20250512-df8de77b"
# https://github.com/kubernetes-sigs/kind/blob/v0.28.0/pkg/build/nodeimage/const_storage.go#L29
...
# https://github.com/kubernetes-sigs/kind/blob/v0.28.0/images/base/files/etc/containerd/config.toml#L37
