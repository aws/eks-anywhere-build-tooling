...
# https://github.com/kubernetes-sigs/kind/blob/v0.31.0/pkg/build/nodeimage/const_cni.go#L23
KINDNETD_IMAGE_TAG="docker.io/kindest/kindnetd:v20251212-v0.29.0-alpha-105-g20ccfc88"
# https://github.com/kubernetes-sigs/kind/blob/v0.31.0/pkg/build/nodeimage/const_storage.go#L29
LOCAL_PATH_PROVISONER_IMAGE_TAG="docker.io/kindest/local-path-provisioner:v20251212-v0.29.0-alpha-105-g20ccfc88"
# https://github.com/kubernetes-sigs/kind/blob/v0.31.0/pkg/build/nodeimage/const_storage.go#L29
LOCAL_PATH_HELPER_IMAGE_TAG="docker.io/kindest/local-path-helper:v20251211-v0.29.0-alpha-100-g82a92c5d"
# https://github.com/kubernetes-sigs/kind/blob/v0.31.0/images/base/files/etc/containerd/config.toml#L37
