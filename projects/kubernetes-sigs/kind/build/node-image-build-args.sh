...
# https://github.com/kubernetes-sigs/kind/blob/v0.23.0/pkg/build/nodeimage/const_cni.go#L23
KINDNETD_IMAGE_TAG="docker.io/kindest/kindnetd:v20240513-cd2ac642"
# https://github.com/kubernetes-sigs/kind/blob/v0.23.0/pkg/build/nodeimage/const_storage.go#L28
LOCAL_PATH_PROVISONER_IMAGE_TAG="docker.io/kindest/local-path-provisioner:v20240513-b9bba138"
# https://github.com/kubernetes-sigs/kind/blob/v0.23.0/pkg/build/nodeimage/const_storage.go#L29
LOCAL_PATH_HELPER_IMAGE_TAG="docker.io/kindest/local-path-helper:v20230510-486859a6"
# https://github.com/kubernetes-sigs/kind/blob/v0.23.0/images/base/files/etc/containerd/config.toml#L37
