...
##@ Build Targets
build: ## Called via prow presubmit, calls `build-raw-ubuntu-2004 fake-ubuntu-2004-raw.gz upload-artifacts-raw-ubuntu-2004 build-raw-ubuntu-2204 fake-ubuntu-2204-raw.gz upload-artifacts-raw-ubuntu-2204 build-raw-redhat-8 fake-redhat-8-raw.gz upload-artifacts-raw-redhat-8 release-raw-ubuntu-2004 upload-bottlerocket-1-raw build-ami-ubuntu-2004 build-ami-ubuntu-2204 upload-bottlerocket-1-ami packer/ova/vsphere.json build-ova-ubuntu-2004 fake-ubuntu-2004-ova.ova upload-artifacts-ova-ubuntu-2004 build-ova-ubuntu-2204 fake-ubuntu-2204-ova.ova upload-artifacts-ova-ubuntu-2204 build-ova-redhat-8 fake-redhat-8-ova.ova upload-artifacts-ova-redhat-8 upload-bottlerocket-1-ova build-cloudstack-redhat-8 fake-redhat-8-cloudstack.qcow2 upload-artifacts-cloudstack-redhat-8 build-nutanix-ubuntu-2004 build-nutanix-ubuntu-2204`
