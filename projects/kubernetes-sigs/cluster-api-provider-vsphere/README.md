...
1. Follow these steps for changes to the patches/ folder:
   1. Fork and clone CAPV repo, and checkout the desired tag. For instance if in step 1 we decided to upgrade to v1.1.0 CAPV version, do `git checkout v1.1.0`
   on your fork.
...
1. Compare the old tag to the new, looking specifically for Makefile changes.
   ex: [1.0.1 compared to 1.1.0](https://github.com/kubernetes-sigs/provider-vsphere/compare/v1.0.1...v1.1.0). Check if the [manifests](https://github.com/kubernetes-sigs/cluster-api-provider-vsphere/blob/v1.1.0/Makefile#L284)
