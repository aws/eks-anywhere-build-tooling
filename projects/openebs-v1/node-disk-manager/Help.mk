...
# _output/bin/node-disk-manager/linux-amd64/manager: ## Build `_output/bin/metallb/linux-amd64/controller`
# _output/bin/node-disk-manager/linux-amd64/ndm-exporter: ## Build `_output/bin/metallb/linux-amd64/speaker`
# _output/bin/node-disk-manager/linux-arm64/manager: ## Build `_output/bin/metallb/linux-arm64/controller`
# _output/bin/node-disk-manager/linux-arm64/ndm-exporter: ## Build `_output/bin/metallb/linux-arm64/speaker`
...
manager/images/amd64: ## Builds/pushes `controller/images/amd64`
ndm-exporter/images/amd64: ## Builds/pushes `speaker/images/amd64`
helm/build: ## Builds/pushes `helm/build`
manager/images/push: ## Builds/pushes `controller/images/push`
ndm-exporter/images/push: ## Builds/pushes `speaker/images/push`
