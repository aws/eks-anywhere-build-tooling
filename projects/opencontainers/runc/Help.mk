...
##@ GIT/Repo Targets
clone-repo:  ## Clone upstream `runc`
checkout-repo: ## Checkout upstream tag based on value in GIT_TAG file

##@ Binary Targets
binaries: ## Build all binaries: `runc` for `linux/amd64 linux/arm64`
...
run-in-docker/runc/eks-anywhere-go-mod-download: ## Run `runc/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/runc/linux-amd64/runc: ## Run `_output/bin/runc/linux-amd64/runc` in docker builder container
run-in-docker/_output/bin/runc/linux-arm64/runc: ## Run `_output/bin/runc/linux-arm64/runc` in docker builder container
