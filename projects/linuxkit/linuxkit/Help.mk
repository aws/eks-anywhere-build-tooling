...
##@ Image Targets
local-images: ## Builds `linuxkit/images/amd64` as oci tars for presumbit validation
images: ## Pushes `linuxkit/images/push` to IMAGE_REPO
linuxkit/images/amd64: ## Builds/pushes `linuxkit/images/amd64`
linuxkit/images/push: ## Builds/pushes `linuxkit/images/push`
...
##@ Build Targets
build: ## Called via prow presubmit, calls `clean`
release: ## Called via prow postsubmit + release jobs, calls `clean`
########### END GENERATED ###########################
