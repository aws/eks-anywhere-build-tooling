...
_output/bin/rufio/linux-amd64/manager: ## Build `_output/bin/rufio/linux-amd64/manager`
_output/bin/rufio/linux-arm64/manager: ## Build `_output/bin/rufio/linux-arm64/manager`

##@ Image Targets
local-images: ## Builds `rufio/images/amd64` as oci tars for presumbit validation
images: ## Pushes `rufio/images/push` to IMAGE_REPO
rufio/images/amd64: ## Builds/pushes `rufio/images/amd64`
rufio/images/push: ## Builds/pushes `rufio/images/push`
...
run-in-docker/rufio/eks-anywhere-go-mod-download: ## Run `rufio/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/rufio/linux-amd64/manager: ## Run `_output/bin/rufio/linux-amd64/manager` in docker builder container
run-in-docker/_output/bin/rufio/linux-arm64/manager: ## Run `_output/bin/rufio/linux-arm64/manager` in docker builder container
