...
run-in-docker/tink/eks-anywhere-go-mod-download: ## Run `tink/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/tink/linux-amd64/tink-controller: ## Run `_output/bin/tink/linux-amd64/tink-controller` in docker builder container
run-in-docker/_output/bin/tink/linux-amd64/tink-server: ## Run `_output/bin/tink/linux-amd64/tink-server` in docker builder container
run-in-docker/_output/bin/tink/linux-amd64/tink-worker: ## Run `_output/bin/tink/linux-amd64/tink-worker` in docker builder container
run-in-docker/_output/bin/tink/linux-arm64/tink-controller: ## Run `_output/bin/tink/linux-arm64/tink-controller` in docker builder container
run-in-docker/_output/bin/tink/linux-arm64/tink-server: ## Run `_output/bin/tink/linux-arm64/tink-server` in docker builder container
run-in-docker/_output/bin/tink/linux-arm64/tink-worker: ## Run `_output/bin/tink/linux-arm64/tink-worker` in docker builder container
