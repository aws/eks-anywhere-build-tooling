...
1. Update checksums and attribution using `make update-attribution-checksums-docker PROJECT=aws/cluster-api-provider-tinkerbell` from the root of the repo.
