...
ex: [1.6.19 compared to 1.6.20](https://github.com/containerd/containerd/compare/v1.6.19...v1.6.20). Check the release [dockerfile](https://github.com/containerd/containerd/blob/main/.github/workflows/release/Dockerfile)
