...
run-in-docker/harbor-scanner-trivy/eks-anywhere-go-mod-download: ## Run `harbor-scanner-trivy/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/harbor-scanner-trivy/linux-amd64/scanner-trivy: ## Run `_output/bin/harbor-scanner-trivy/linux-amd64/scanner-trivy` in docker builder container
run-in-docker/_output/bin/harbor-scanner-trivy/linux-arm64/scanner-trivy: ## Run `_output/bin/harbor-scanner-trivy/linux-arm64/scanner-trivy` in docker builder container
