...
run-in-docker/cluster-api-provider-nutanix/eks-anywhere-go-mod-download: ## Run `cluster-api-provider-nutanix/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/cluster-api-provider-nutanix/linux-amd64/manager: ## Run `_output/bin/cluster-api-provider-nutanix/linux-amd64/manager` in docker builder container
run-in-docker/_output/bin/cluster-api-provider-nutanix/linux-arm64/manager: ## Run `_output/bin/cluster-api-provider-nutanix/linux-arm64/manager` in docker builder container
