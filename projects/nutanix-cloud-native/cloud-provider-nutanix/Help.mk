...
##@ GIT/Repo Targets
clone-repo:  ## Clone upstream `cloud-provider-nutanix`
checkout-repo: ## Checkout upstream tag based on value in GIT_TAG file

##@ Binary Targets
binaries: ## Build all binaries: `controller` for `linux/amd64 linux/arm64`
_output/bin/cloud-provider-nutanix/linux-amd64/controller: ## Build `_output/bin/cloud-provider-nutanix/linux-amd64/controller`
_output/bin/cloud-provider-nutanix/linux-arm64/controller: ## Build `_output/bin/cloud-provider-nutanix/linux-arm64/controller`

##@ Image Targets
local-images: ## Builds `cloud-provider-nutanix/images/amd64` as oci tars for presumbit validation
images: ## Pushes `cloud-provider-nutanix/images/push` to IMAGE_REPO
cloud-provider-nutanix/images/amd64: ## Builds/pushes `cloud-provider-nutanix/images/amd64`
cloud-provider-nutanix/images/push: ## Builds/pushes `cloud-provider-nutanix/images/push`
...
run-in-docker/cloud-provider-nutanix/eks-anywhere-go-mod-download: ## Run `cloud-provider-nutanix/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/cloud-provider-nutanix/linux-amd64/controller: ## Run `_output/bin/cloud-provider-nutanix/linux-amd64/controller` in docker builder container
run-in-docker/_output/bin/cloud-provider-nutanix/linux-arm64/controller: ## Run `_output/bin/cloud-provider-nutanix/linux-arm64/controller` in docker builder container
