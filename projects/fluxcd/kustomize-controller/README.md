...
![Version](https://img.shields.io/badge/version-v0.24.3-blue)
...
ex: [0.19.0 compared to 0.24.1](https://github.com/fluxcd/kustomize-controller/compare/v0.19.0...v0.24.3). Check the `manager` target for
