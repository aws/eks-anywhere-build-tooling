...
run-in-docker/kustomize-controller/eks-anywhere-go-mod-download: ## Run `kustomize-controller/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/kustomize-controller/linux-amd64/kustomize-controller: ## Run `_output/bin/kustomize-controller/linux-amd64/kustomize-controller` in docker builder container
run-in-docker/_output/bin/kustomize-controller/linux-arm64/kustomize-controller: ## Run `_output/bin/kustomize-controller/linux-arm64/kustomize-controller` in docker builder container
