...
run-in-docker/source-controller/eks-anywhere-go-mod-download: ## Run `source-controller/eks-anywhere-go-mod-download` in docker builder container
run-in-docker/_output/bin/source-controller/linux-amd64/source-controller: ## Run `_output/bin/source-controller/linux-amd64/source-controller` in docker builder container
run-in-docker/_output/bin/source-controller/linux-arm64/source-controller: ## Run `_output/bin/source-controller/linux-arm64/source-controller` in docker builder container
