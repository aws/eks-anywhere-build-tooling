## **Source Controller**
![Version](https://img.shields.io/badge/version-v1.0.0-rc.5-blue)
...
ex: [v1.0.0-rc.3 compared to v1.0.0-rc.5](https://github.com/fluxcd/source-controller/compare/v1.0.0-rc.3...v1.0.0-rc.5). Check the `build` target for
