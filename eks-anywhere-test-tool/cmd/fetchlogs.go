...
type e2eFetchLogsOptions struct {
	forBuildId string
}

var fl = &e2eFetchLogsOptions{}
...
var e2eFetchLogsCommand = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var opts []logs2.FetchLogsOpt
		if fl.forBuildId != "" {
			opts = append(opts, logs2.WithCodebuildBuild(fl.forBuildId))
		}

		fetcher := logs2.New(buildAccountCw, testAccountCw, buildAccountCodebuild, writer)
...
func init() {
	...
	err := viper.BindPFlags(e2eFetchLogsCommand.Flags()); if err != nil {
